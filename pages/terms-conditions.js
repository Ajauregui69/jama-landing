  ...
  render() {
    return (
      <>
        ...
        <div className="container text-container ptb-100">
          <div className="row">
            ...
            <ul>
              ...
              <li>
                <p>
                  <strong>Country</strong> refers to: Mexico
                </p>
              </li>
              <li>
                <p>
                  ...
                  Company&quot;, &quot;We&quot;, &quot;Us&quot; or
                  &quot;Our&quot; in this Agreement) refers to JAMA Security.
                </p>
              </li>
              <li>
                <p>
              ...
              <li>
                <p>
                  <strong>Website</strong> refers to JAMA Security, accessible
                  from{" "}
                  <a
                    href="www.jamasecurity.com"
                    rel="external nofollow noopener"
                    target="_blank"
                  >
                    www.jamasecurity.com
                  </a>
                </p>
              </li>
              <li>
            ...
            <p>
              ...
              no-reply@jamasecurity.com and include in Your notice a detailed
            ...
            <p>
              ...
              no-reply@jamasecurity.com. Upon receipt of a notification, the
            ...
            <ul>
              <li>By email: info@jamasecurity.com</li>
            </ul>
          </div>
        </div>
